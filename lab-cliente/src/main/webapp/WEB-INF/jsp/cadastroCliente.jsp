...
=======
	<h1>Cadastro</h1>
>>>>>>> 2df57d4 Finalizando desenvolvimento das Views com CSS e BootStrap.
...
<<<<<<< Upstream, based on origin/master
				...
				<spring:bind path="endereco.cep">
					<div class="form-group ${status.error ? 'has-error' : ''}">
						...
						<div class="col-sm-4">
							<form:input path="endereco.cep" type="number" class="form-control"
								id="cep" placeholder="CEP" maxlength="8" />
				...
				<spring:bind path="endereco.bairro">
					<div class="form-group ${status.error ? 'has-error' : ''}">
						...
						<div class="col-sm-4">
							<form:input path="endereco.bairro" type="text" class="form-control"
				...
				<spring:bind path="endereco.logradouro">
					<div class="form-group ${status.error ? 'has-error' : ''}">
						...
						<div class="col-sm-4">
							<form:input path="endereco.logradouro" type="text" class="form-control"
						...
						<div class="col-sm-2">
							<form:input path="endereco.numero" type="number" class="form-control"
				...
				<spring:bind path="endereco.cidade">
					<div class="form-group ${status.error ? 'has-error' : ''}">
						...
						<div class="col-sm-4">
							<form:input path="endereco.cidade" type="text" class="form-control"
				...
				<spring:bind path="telefone.fixo">
					<div class="form-group ${status.error ? 'has-error' : ''}">
						...
						<div class="col-sm-3">
							<form:input path="telefone.fixo" type="number" class="form-control"
								id="telefoneFixo" placeholder="Telefone Fixo" />
							<form:errors path="telefone.fixo" class="control-label" />
						</div>
						
						<label class="col-sm-2 control-label">Telefone Celular</label>
						<div class="col-sm-3">
							<form:input path="telefone.celular" type="number" class="form-control"
								id="telefoneCelular" placeholder="Telefone Celular" />
